...
if (( "$GIT_STATUS" > 0 )); then
	...
	dotnet add Microting.eFormBasicCaseManagementBase/Microting.eFormBasicCaseManagementBase.csproj package Microting.eForm
	dotnet add Microting.eFormBasicCaseManagementBase/Microting.eFormBasicCaseManagementBase.csproj package Microting.eFormApi.BasePn
